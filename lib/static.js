...
var staticApp = {
    ...
    validDirs: [ 'js', 'js/src', 'src', 'bin', 'css', 'style', 'view', 'view/game', 'views', 'img', 'images', 'tpl' ],
    formats: {
        'js': 'text/javascript',
        'html': 'text/html',
        'tpl': 'text/html',
    ...
    report404: function( url, ipaddr ) {
    	...
    	buf = new Date() + ' :404: ' + url + ' from ' + ipaddr + "\n";
    	fs.writeSync(h, buf);
    	fs.closeSync(h);
    },
    ...
    report200: function( url, ipaddr ) {
    	...
    	buf = new Date() + ' :200: ' + url + ' from ' + ipaddr + "\n";
    	fs.writeSync(h, buf);
    	fs.closeSync(h);
    },
    ...
    reportError: function( code, url, ipaddr ) {
    	...
    	buf = new Date() + ' :' + code + ': ' + url + ' from ' + ipaddr + "\n";
    	fs.writeSync(h, buf);
    	fs.closeSync(h);
    },
    ...
    reportrequest: function( url, ipaddr ) {
    	...
    	buf = new Date() + ' :Request: ' + url + ' from ' + ipaddr + "\n";
    	fs.writeSync(h, buf);
    	fs.closeSync(h);
    },
