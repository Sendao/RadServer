module.exports = function GithubData() {
    ...
    this.removeProjects = function(params) {
        ...
        this.app.socket().changeProp("project." + prjid, null);
        return true;
    };
    ...
    this.postBranches = function(params) {
        ...
        this.ctrl.changeProp("branch." + prj.id, prj);
    ...
    this.removeBranches = function(params) {
        ...
        var prjid = prj.id;
        xd.deleteRecordsById([prjid]);
        this.app.socket().changeProp("branch." + prjid, null);
        return true;
    };
    ...
    this.postTargets = function(params) {
        ...
        this.ctrl.changeProp("target." + prj.id, prj);
    ...
    this.removeTargets = function(params) {
        ...
        var prjid = prj.id;
        xd.deleteRecordsById([prjid]);
        this.app.socket().changeProp("target." + prjid, null);
        return true;
    };
