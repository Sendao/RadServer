module.exports = function BranchesSinglet(myapp) {
    ...
    this.Data = function() {
        ...
        this.Users = function() {
            this.name = 'users';
            this.indice = { 'id': {}, "name": {} };
            this.defaults = { 'name': '', 'email': '', 'password': '', 'dtlast': 0 };
            db.convey.call(this, 'auth');
        };
        ...
        this.Sessions = function() {
            this.name = 'sessions';
            this.indice = {  'id': {}, "key": {} };
            this.defaults = { 'key': '', 'fed': '', 'userid': '', 'dtstamp': 0 };
            db.convey.call(this, 'auth' );
        };
    ...
    */
    ...
    this.logout = function(req, res, params) {
        var auth = this.authSession(params);
        if( auth === false ) {
            res.send(200, {}, {'status': 'missing'});
            return;
        }
        auth.userid = false;
        auth.idcode = false;
    ...
    this.signin = function(req, res, params) {
        ...
        var users = this.base.users.search('name', params['username']);
    ...
    this.signup = function(req, res, params) {
        ...
        sess.idcode = newuser.identityCode;
