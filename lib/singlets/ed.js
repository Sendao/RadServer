module.exports = function BranchesSinglet(myapp) {
    ...
    this.runCommand = function(req, res, params) {
        ...
        if( securityEnabled ) {
            ...
            sess = this.app.authSession(res, params);
        }
    ...
    this.getTables = function(req, res, params)
    {
        ...
        for( base in this.app.db.bases ) {
            ...
            for( table in tables ) {
                ...
                bases[base]['tables'][table] = { 'defaults': xd.defaults, 'indexes': indexlist };
            }
        }
        res.send(200, {}, {'status': 'ok', 'data': bases});
    };
    ...
    this.updData = function(req, res, params)
    {
        ...
        res.send(200, {}, {'status': 'ok', 'data': el} );
    };
};
