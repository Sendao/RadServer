...
export function i3_render(i3_sound)
{
...
export function i3_animate()
{
	requestAnimationFrame( i3_animate );
  i3_draw();
}

export function i3_draw() {
