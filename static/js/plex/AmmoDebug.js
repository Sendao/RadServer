...
var ThreeAmmoDebugger = function(scene, world, options){
  options = options || {};
...
ThreeAmmoDebugger.prototype = function() {
  return this.debugDrawer;
};

ThreeAmmoDebugger.prototype.enable = function(){
  this.enabled = true;
  this.scene.add(this.debugObject);
};

ThreeAmmoDebugger.prototype.disable = function() {
  this.enabled = false;
  this.scene.remove(this.debugObject);
};

ThreeAmmoDebugger.prototype.update = function(){
  if (!this.enabled) {
    return;
  }
...
ThreeAmmoDebugger.prototype.drawLine = function(from, to, color) {
  if (this.clearDebug) {
...
ThreeAmmoDebugger.prototype.drawContactPoint = function(pointOnB, normalOnB, distance, lifeTime, color) {
  //TODO
  console.log("drawContactPoint")
};

ThreeAmmoDebugger.prototype.reportErrorWarning = function(warningString) {
  console.warn(warningString);
};

ThreeAmmoDebugger.prototype.draw3dText = function(location, textString) {
  //TODO
  console.log("draw3dText", location, textString);
};

ThreeAmmoDebugger.prototype.setDebugMode = function(debugMode) {
  this.debugDrawMode = debugMode;
};

ThreeAmmoDebugger.prototype.getDebugMode = function() {
  return this.debugDrawMode;
};

export { ThreeAmmoDebugger };
